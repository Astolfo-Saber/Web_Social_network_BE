        ...
        public static void Main(string[] args)
        {
            ...
            builder.Services.AddCors(options =>
            {
                options.AddPolicy("AllowAllOrigins",
                    builder =>
                    {
                        builder.WithOrigins("https://localhost:7261", "https://localhost:44351")
                            .AllowAnyHeader()
                            .AllowAnyMethod()
                            .AllowCredentials();
                    });
            ...
            builder.Services.AddDbContext<SocialNetworkN01Ver3Context>();
			...
			builder.Services.AddScoped<INewfeedRepository, NewfeedRepository>();
			// ------------------------------------------------------------//
